  ...
  return (
    <button
      ...
      className={cn(
        ...
        "border border-border/60 sm:dark:border-border/50 dark:bg-main-foreground/10 dark:border-white/5 sm:dark:hover:bg-main-foreground/20 sm:dark:hover:border-white/10",
