...
const STEPS = [
  ...
  },
  {
    title: "Results",
    description:
      "Zed UI will add extra shine to your application, with smooth components.",
  },
  {
    title: "Copy now",
    description:
...
export function MultiStepModal() {
  ...
  return (
    <div className="max-w-[370px] overflow-hidden rounded-xl border border-[#dddddd] bg-neutral-100 dark:border-[#222222] dark:bg-[#111111]">
