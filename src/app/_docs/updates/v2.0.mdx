...
You can learn more in the <Link href="/ui/cli">CLI docs</Link>. Start with <CodeHighlight>npx zed-ui init</CodeHighlight>, then use <CodeHighlight>npx zed-ui add</CodeHighlight> to add components to your project.
