...
<CommandBlock
	npmCommand="npx zed-ui add button"
	pnpmCommand="pnpm dlx zed-ui add button"
	yarnCommand="npx zed-ui add button"
	bunCommand="bunx --bun zed-ui add button"
/>
...
Add the animations and variable colors in your CSS File
